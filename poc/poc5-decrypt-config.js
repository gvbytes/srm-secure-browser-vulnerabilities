/**
 * PoC 5: Decrypt Firebase Credentials with Hardcoded AES Key
 * Target: chrome-tabs/renderer.js (obfuscated string table)
 * Impact: Decrypts server configurations using recovered static AES-128-ECB keys.
 */
