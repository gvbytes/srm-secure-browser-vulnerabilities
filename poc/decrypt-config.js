/**
 * Proof of Concept: Decrypting Hardcoded Config Keys
 * 
 * Demonstrates VULN-005 (Hardcoded AES Encryption Keys).
 * Decrypts config payloads using the recovered static AES keys.
 */

const crypto = require('crypto');

// Recovered hardcoded 16-byte keys
